...
public class SessionResponse {
    ...
    public static SessionResponse fromEntity(CodingSession session) {
        return SessionResponse.builder()
                ...
                .topicCategory(session.getTopic() != null ? session.getTopic().getCategory() : null)
                .languageName(session.getLanguage() != null ? session.getLanguage().getName() : null)
                .languageColorHex(session.getLanguage() != null ? session.getLanguage().getColorHex() : null)
